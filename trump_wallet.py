...
def register_trump_wallet(scraper, email: str, phone: str, twitter: str, referrer_id: str = "sgbZIhiUAqTyeSNA0ejN"):
    headers = {
...
async def main():
    ...
    proxy_dict = None
    if PROXY_CONFIG["http"] or PROXY_CONFIG["https"]:
        proxy_dict = {k: v for k, v in PROXY_CONFIG.items() if v}
    ...
    async with httpx.AsyncClient(timeout=30) as email_client:
        try:
            ...
            register_trump_wallet(trump_session, email, phone, twitter)
